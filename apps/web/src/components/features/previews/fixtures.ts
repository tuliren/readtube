...
export const INBOX_ROWS: InboxRow[] = [
  {
    ...
    channelName: 'Quanta',
    channelInitial: 'Q',
    channelTint: 'bg-emerald-100 text-emerald-700',
    durationLabel: '21 min',
    publishedLabel: '3d ago',
    isUnread: true,
    isStarred: true,
  ...
  },
  {
    ...
    channelInitial: 'V',
    channelTint: 'bg-amber-100 text-amber-700',
  ...
  },
  {
    ...
    channelInitial: 'A',
    channelTint: 'bg-rose-100 text-rose-700',
  ...
  },
  {
    ...
    channelInitial: 'T',
    channelTint: 'bg-sky-100 text-sky-700',
  ...
  },
  {
    ...
    channelInitial: 'C',
    channelTint: 'bg-indigo-100 text-indigo-700',
  ...
  },
  {
    ...
    channelInitial: 'R',
    channelTint: 'bg-violet-100 text-violet-700',
