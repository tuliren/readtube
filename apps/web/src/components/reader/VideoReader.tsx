          ...
          {transcriptStatus === 'unavailable' ? (
            ...
            <>
              ...
              {(activeTab === 'summary' || activeTab === 'article') && (
                <p className="mt-10 border-t border-gray-100 pt-4 text-xs text-gray-400 italic">
                  This {activeTab} was generated by AI from the video&rsquo;s transcript and may
                  contain errors, omissions, or misinterpretations. Treat it as a quick reference,
