...
async function generateSummaryStep(input: SummaryWorkflowInput): Promise<GeneratedSummary> {
  'use step';
...
async function persistSummaryStep(input: SummaryWorkflowInput & GeneratedSummary): Promise<void> {
  'use step';
...
async function emitTerminalEventStep(event: SummaryStreamEvent): Promise<void> {
  'use step';
