...
async function generateArticleStep(input: ArticleWorkflowInput): Promise<GeneratedArticle> {
  'use step';
...
async function persistArticleStep(input: ArticleWorkflowInput & GeneratedArticle): Promise<void> {
  'use step';
...
async function emitTerminalEventStep(event: ArticleStreamEvent): Promise<void> {
  'use step';
